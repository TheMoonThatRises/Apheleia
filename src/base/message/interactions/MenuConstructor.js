...
class MenuConstructor extends Constructor {
    static Options = class extends Constructor {
        static options = {"label": "", "value": "", "description": "", "emoji": {}, "default": false};
    ...
    static options = {"custom_id": "", "options": [], "placeholder": "", "min_values": 1, "max_values": 1, "disabled": false};
    ...
    addOption(option = MenuConstructor.Options) {
        if (!(option instanceof MenuConstructor.Options)) throw new Error("Option must be instance of MenuConstructor.Options.");
